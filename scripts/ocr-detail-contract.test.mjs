...
assertIncludes(contentBlock, 'gap: var(--space-card-padding);', 'OcrDetail must use shared spacing tokens.')
...
assertIncludes(imageToolbarBlock, 'gap: var(--space-card-padding);', 'OcrDetail toolbar must match the content gap.')
assertIncludes(imageToolbarBlock, 'padding: var(--space-card-padding);', 'OcrDetail toolbar must start from the padded content edge.')
