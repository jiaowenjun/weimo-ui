...
assert.deepEqual(
  ...
  ['token-preview-card', 'text-color', 'pressable', 'heat-color', 'bg-blur', 'border-radius'],
  'Merged token utilities and the debug-free TokenPreviewCard must remain public without separate docs pages.',
)
